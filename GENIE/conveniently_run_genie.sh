...
if [ $genie_config == "G18_10j_00_000" ] || [ $genie_config == "N18_10j_02_11a-resfixfix" ] || [ $genie_config == "DefaultPlusMECWithNC" ] || [ $genie_config == "G18_02a_02_11a" ] || [ $genie_config == "G18_01a_02_11a" ] || [ $genie_config == "G18_02a_02_11b" ] || [ $genie_config == "G18_02b_02_11a" ];
then
	setup genie v3_04_00 -q e20:inclxx:prof
fi
