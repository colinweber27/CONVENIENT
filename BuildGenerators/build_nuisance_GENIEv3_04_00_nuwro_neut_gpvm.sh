...
# Date: 8 April 2024
# Purpose: To build NUISANCE w/ GENIE v3_04_00, NuWro, and NEUT within 
# Convenient.
# Assumes GENIE v3_04_00 has already been set up via ups in the novasoft 
...
# Get the latest NUISANCE version.
...
mkdir -p build
cd build
cmake -DUSE_MINIMIZER=1 -DNuWro_ENABLED=ON -DGENIE_ENABLED=ON -DEXPERIMENTS_ENABLED=OFF -DNEUT_ENABLED=ON ../
...
source nuisance_GENIEv3_04_00_nuwro_neut_env.sh
echo "DONE!"
